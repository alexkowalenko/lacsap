...
class Constants {
  public:
    ...
    class ConstDecl {
      public:
        ConstDecl(ConstKind k, const Location &w) : kind(k), loc(w) {}
        virtual ~ConstDecl() {}
    ...
    class IntConstDecl : public ConstDecl {
      public:
        IntConstDecl(const Location &w, uint64_t v) : ConstDecl(CK_IntConstDecl, w), value(v) {}
    ...
    class RealConstDecl : public ConstDecl {
      public:
        RealConstDecl(const Location &w, double v) : ConstDecl(CK_RealConstDecl, w), value(v) {}
        Token       Translate() const override;
    ...
    class CharConstDecl : public ConstDecl {
      public:
        CharConstDecl(const Location &w, char v) : ConstDecl(CK_CharConstDecl, w), value(v) {}
        Token       Translate() const override;
    ...
    class BoolConstDecl : public ConstDecl {
      public:
        BoolConstDecl(const Location &w, bool v) : ConstDecl(CK_BoolConstDecl, w), value(v) {}
        Token       Translate() const override;

...
class ExprAST : public Visitable<ExprAST> {
  ...
  public:
    ...
    void                 dump() const;
    virtual void         DoDump(std::ostream &out) const { out << "Empty node"; }
...
class FunctionAST : public ExprAST {
  public:
    FunctionAST(const Location &w, PrototypeAST *prot, const std::vector<VarDeclAST *> &v,
                BlockAST *b);
    void                DoDump(std::ostream &out) const override;
...
class ForExprAST : public ExprAST {
  public:
    friend class TypeCheckVisitor;
    ForExprAST(const Location &w, VariableExprAST *v, ExprAST *s, ExprAST *e, bool down,
               ExprAST *b)
...
class CaseExprAST : public ExprAST {
  public:
    CaseExprAST(const Location &w, ExprAST *e, const std::vector<LabelExprAST *> &lab,
                ExprAST *other)
...
class TrampolineAST : public FunctionExprAST {
  public:
    TrampolineAST(const Location &w, FunctionExprAST *fn, ClosureAST *c,
                  Types::FuncPtrDecl *fnPtrTy)

...
llvm::Value *BuiltinFunctionDispose::CodeGen(llvm::IRBuilder<> &builder) {
    ...
    llvm::Constant *f = GetFunction(Types::GetVoidType(), {ty}, "__dispose");
...
llvm::Value *BuiltinFunctionHalt::CodeGen(llvm::IRBuilder<> &builder) {
    ...
    llvm::Constant *f =
        GetFunction(Types::GetVoidType(), {Types::GetIntegerType()->LlvmType()}, "exit");
...
llvm::Value *BuiltinFunctionFloat2Arg::CodeGen(llvm::IRBuilder<> &builder) {
    ...
    llvm::Constant *f = GetFunction(realTy, {realTy, realTy}, funcname);
...
llvm::Value *BuiltinFunctionParamstr::CodeGen(llvm::IRBuilder<> &builder) {
    ...
    llvm::FunctionType *ft =
        llvm::FunctionType::get(Types::GetStringType()->LlvmType(), argTypes, false);
...
llvm::Value *BuiltinFunctionParamcount::CodeGen(llvm::IRBuilder<> &builder) {
    llvm::Constant *f = GetFunction(Types::GetIntegerType(), {}, "__ParamCount");
...
#define NEW2(name, func)                                                                          \
    [](ArgList &a) -> BuiltinFunctionBase * { return new BuiltinFunction##name(func, a); }
